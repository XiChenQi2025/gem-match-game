...
const GemMatchGame = {
    ...
    async _runGameCycle() {
        ...
        await this._step2_checkFullHouse();
        await this._delay(100);
        await this._step3_checkThreeInARow();
        await this._delay(100);
        await this._step4_checkPairs();
        await this._delay(300); // 给消除动画更多时间
        await this._step5_supplementGems();
        await this._delay(300); // 给填充动画更多时间
