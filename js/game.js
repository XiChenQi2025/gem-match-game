...
const GemMatchGame = {
    ...
    async _runGameCycle() {
        ...
        await this._delay(200); // 延长延迟
        
        // 第2-5步: 进入"消除-补充"循环
        let eliminationOccurred;
        let loopCount = 0;
        const MAX_LOOPS = 20; // 安全措施，防止无限循环
        ...
        do {
            ...
            if ((eliminationOccurred || this.state.spareGems > 0) && this._hasEmptyCells()) {
                ...
                await this._delay(500); // 延长延迟，给填充动画更长时间
            }
